...
The SQL grammar is defined at @ [github://janhoon/tree-sitter-sql](https://github.com/DerekStride/tree-sitter-sql).
You can view the latest parser artifacts on site or on the [gh-pages
branch](https://github.com/janhoon/tree-sitter-sql/tree/gh-pages/src).
